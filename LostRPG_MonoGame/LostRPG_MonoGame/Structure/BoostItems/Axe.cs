...
//        public Axe(int sizeX, int sizeY, int x, int y, SpriteType sprite, int healthPointsBoost, int damagePointBoost, int defensePointsBoost) : base(sizeX, sizeY, x, y, sprite, healthPointsBoost, damagePointBoost, defensePointsBoost)
//        {
//        }
//    }
//}
