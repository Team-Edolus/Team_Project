namespace RPG_AdvancedCS_May.Structure
{
    ...
    public class Shield : Item
    {
        ...
        public Shield(int x, int y) : base(x, y, ShieldDefaultSizeX, ShieldDefaultSizeY, Shield_DEFAULT_HEALTH_BOOST, Shield_DEFAULT_DAMAGE_BOOST, Shield_DEFAULT_DEFENCE_BOOST, ShieldDefaultSprite)
        {
        }
